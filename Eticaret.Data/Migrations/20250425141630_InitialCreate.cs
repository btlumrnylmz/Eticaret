        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "varchar(50)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2025, 4, 25, 17, 16, 29, 517, DateTimeKind.Local).AddTicks(3872), "admin@eticaret.io", true, true, "test", "123456*", null, "test", new Guid("a08400de-7df3-452a-a950-1ea4a83eb7ca"), "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 4, 25, 17, 16, 29, 522, DateTimeKind.Local).AddTicks(7382), null, null, true, true, "Elektronik", 1, 0 },
                    { 2, new DateTime(2025, 4, 25, 17, 16, 29, 522, DateTimeKind.Local).AddTicks(8743), null, null, true, true, "Bilgisayar", 2, 0 }
                });
